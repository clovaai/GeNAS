'''
Copied from https://github.com/megvii-model/RLNAS/blob/main/darts_search_space/cifar10/rlnas/train_supernet/super_model.py
'''
import torch
...
if __name__ == '__main__':
    ...
    print("norm rng: ", norm_rng)
    norm_rng = check_cand(norm_rng, operations)
    print("after check_cand norm_rng: ", norm_rng)
